...
"         Configure the list of filetypes vim-parinfer should register mappings
"         for.
"
"     g:vim_parinfer_mode
"         Tells vim-parinfer to start parinfer in the specified mode.
"         Possible values are 'indent' (default), and 'paren'.
"
" COMMANDS:
"     :ToggleParinferMode
"         Toggle between the different parinfer modes (from 'indent' to 'paren'
"         and vice versa).
"
" MAPPINGS:
